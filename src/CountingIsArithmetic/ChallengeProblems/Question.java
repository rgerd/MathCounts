...
public class Question extends com.Question {
	...
	static {
		/* type 1 */ questions[0] = "How many positive integers less than [num_0] can be written as the sum of 2 positive perfect squares?";
		...
		/*type 3.1*/ questions[5] = "What is the units digit of 1! + 2! + 3! + 4! + É + [num_0] ?";
